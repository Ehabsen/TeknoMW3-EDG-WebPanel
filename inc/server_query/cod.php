...
######## CONFIG ##############################################################################################################
  ...
  $server_name_config = array('callofduty2'          => array('Call of Duty 2',                    'CoD 2'),
                              ...
                              'callofdutyblackops'   => array('Call of Duty Black Ops',            'CoD BO'),
                              'iw4'   => array('Call of Duty Modern Warfare 2',          'CoD MW2'),
                              
  );

  $server_link_config = array(
    'callofduty2'           => 'cod2://{IP}:{S_PORT}'  ,
    'callofduty4'           => 'cod4://{IP}:{S_PORT}'  ,                                                   /*added by Vulcano*/
    'codunitedoffensive'    => 'coduo://{IP}:{S_PORT}' ,                                                   /*added by Vulcano*/
    'callofdutyworldatwar'  => 'codwaw://{IP}:{S_PORT}',                                                   /*added by Vulcano*/
    'callofdutyblackops'    => 'codbo://{IP}:{S_PORT}' ,                                                   /*added by Vulcano*/
    'iw4'    => 'aiw://connect/{IP}:{S_PORT}' ,                                                   /*added by Vulcano*/
  );
